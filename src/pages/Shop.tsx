...
const bgIcons = [
  "/shop/icons/shop1.svg",
  "/shop/icons/shop2.svg",
  "/shop/icons/shop3.svg",
  "/shop/icons/shop4.svg",
  "/shop/icons/shop5.svg",
  "/shop/icons/shop6.svg",
  "/shop/icons/shop7.svg",
  "/shop/icons/shop8.svg",
  "/shop/icons/shop9.svg",
  "/shop/icons/shop10.svg",
  "/shop/icons/shop11.svg",
  "/shop/icons/shop12.svg",
  "/shop/icons/shop13.svg",
];
...
const Shop = () => {
  useEffect(() => {
    ...
    // 💡 Animate soft glowing lights floating slowly
  ...
  return (
    <div className="min-h-screen bg-[#001117] backdrop-blur-2xl pt-28 pb-12 relative overflow-hidden w-full">
      ...
      {/* ✨ Background Icons (You can replace with downloaded SVGs) */}
      {/* Background Icons */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
